...
def setting_bg():
    st.markdown(f""" <style>.stApp {{
                        background: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoWuLDkW1TQQrHp39vbw6skbbMwffbDNbFmw&usqp=CAU");
...
<div style='text-align:center'>
    <h1 style='color:#DAF7A6;'>Industrial Copper Modeling Application</h1>
</div>
...
with tab1:
    ...
    with st.form("my_form"):
        ...
        with col3:
            st.write(
                f'<h5 style="color: #FFC300;">NOTE: Min & Max given for reference, you can enter any value</h5>',
                unsafe_allow_html=True)
    ...
    if submit_button and flag == 0:
        ...
        st.write('## :orange[Predicted selling price:] ', np.exp(new_pred))
